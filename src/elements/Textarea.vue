...
$color-placeholder: tint($color-gray-light, 50%);
...
.textarea {
  ...
  textarea {
    ...
    color: set-text-color($color-gray-dark, $color-white);
    width: 100%;
    margin: 0;
    border: 0;
    box-shadow: inset 0 1px 0 0 rgba($color-gray-dark, 0.07), 0 0 0 1px tint($color-gray-dark, 80%);
    ...
    &:hover,
    &.hover {
      box-shadow: 0 1px 5px 0 rgba($color-gray-dark, 0.07), 0 0 0 1px tint($color-gray-dark, 60%);
    }
    &:focus,
    &.focus {
      transition: box-shadow 0.2s ease;
      box-shadow: inset 0 0 0 1px $color-gray, 0 0 0 1px $color-gray;
      outline: 0;
    }
    &[disabled] {
      -webkit-font-smoothing: antialiased;
      box-shadow: 0 0 0 1px tint($color-gray-dark, 80%);
