<template>
  <div class="mc-field-select-old" :class="classes">
    <multiselect
      :value="_value"
      :options="options"
      label="name"
    ...
    >
      <template slot="singleLabel" slot-scope="props">
        <div v-if="avatar" class="mc-field-select-old__avatar-wrap">
          <div class="mc-field-select-old__avatar">
            <!--<ElAvatar size="ex-small" :src="avatar" />-->
          </div>
          <div class="mc-field-select-old__avatar-text">
            {{ props.option ? props.option.name : this.placeholder }}
          </div>
        </div>
        <template v-else>
          <div class="mc-field-select-old__avatar-wrap">
            <div class="mc-field-select-old__avatar-text mc-field-select-old__avatar-text--no-img">
              {{ props.option ? props.option.name : this.placeholder }}
            </div>
          </div>
        </template>
    ...
    <span v-if="errorText" class="mc-field-select-old__help-text">{{ errorText }}</span>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    classes() {
      let result = {
        "mc-field-select-old--error": this.errorText,
      }
      if (this.backgroundColor) result[`mc-field-select-old--color-${this.backgroundColor}`] = true
      return result
    },
    errorText() {
...
.mc-field-select-old:not([class^="mc-field-select-old mc-field-select-old--color"]) {
...
[class^="mc-field-select-old mc-field-select-old--color"] {
  .multiselect {
    &--active {
      .multiselect {
        &__tags {
