    ...
    <span class="mc-field-text__input-wrap">
      <span class="mc-field-text__input-inner">
        ...
        <template v-if="type === 'search'">
          <button
            tabindex="-1"
            class="mc-field-text__input-btn-search"
            type="submit"
            @click.prevent="handleSearch"
          >
            <McSvgIcon
              class="mc-field-text__input-btn-search-icon"
              name="baseline-search-24px"
              width="24"
              height="24"
            />
          </button>
          <button
            tabindex="-1"
            class="mc-field-text__input-btn-close"
            type="button"
            @click.prevent="clearField"
          >
            <McSvgIcon
              class="mc-field-text__input-btn-close-icon"
              width="14"
              height="14"
              name="baseline-close-24px"
            />
          </button>
        </template>
